...
> = {
  ...
  >
  status?: Resolver<
    Maybe<ResolversTypes['MaintenanceRequestStatus']>,
    ParentType,
    ContextType
  >
  ...
  urgency?: Resolver<
    Maybe<ResolversTypes['MaintenanceRequestUrgency']>,
    ParentType,
    ContextType
  >
...
> = {
  ...
  updateMaintenanceRequest?: Resolver<
    ...
    ContextType,
    RequireFields<
      MutationUpdateMaintenanceRequestArgs,
      '_id' | 'body' | 'title'
    >
  >
}
...
> = {
  findAllMaintenanceRequests?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['MaintenanceRequest']>>>,
    ParentType,
    ContextType
  >
