...
export type MaintenanceRequestResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['MaintenanceRequest'] = ResolversParentTypes['MaintenanceRequest'],
> = {
  ...
  status?: Resolver<
    ResolversTypes['MaintenanceRequestStatus'],
    ParentType,
    ContextType
  >
  ...
  urgency?: Resolver<
    ResolversTypes['MaintenanceRequestUrgency'],
    ParentType,
    ContextType
  >
...
export type MaintenanceRequestSummaryResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['MaintenanceRequestSummary'] = ResolversParentTypes['MaintenanceRequestSummary'],
> = {
  averageDaysToResolve?: Resolver<
...
> = {
  createMaintenanceRequest?: Resolver<
    Maybe<ResolversTypes['MaintenanceRequest']>,
    ParentType,
    ContextType,
    RequireFields<MutationCreateMaintenanceRequestArgs, 'body'>
  >
  deleteMaintenanceRequest?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteMaintenanceRequestArgs, '_id'>
  >
  markAsResolvedMaintenanceRequest?: Resolver<
    Maybe<ResolversTypes['MaintenanceRequest']>,
    ParentType,
    ContextType,
    RequireFields<MutationMarkAsResolvedMaintenanceRequestArgs, '_id'>
  >
  updateMaintenanceRequest?: Resolver<
    Maybe<ResolversTypes['MaintenanceRequest']>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateMaintenanceRequestArgs, '_id' | 'body'>
  >
}
...
> = {
  findAllMaintenanceRequests?: Resolver<
    Maybe<Array<ResolversTypes['MaintenanceRequest']>>,
    ParentType,
    ContextType
  >
  findOneMaintenanceRequest?: Resolver<
    Maybe<ResolversTypes['MaintenanceRequest']>,
    ParentType,
    ContextType,
    RequireFields<QueryFindOneMaintenanceRequestArgs, '_id'>
  >
  summaryMaintenanceRequest?: Resolver<
    ResolversTypes['MaintenanceRequestSummary'],
    ParentType,
    ContextType
  >
}
...
> = {
  maintenanceRequestCreated?: SubscriptionResolver<
    ResolversTypes['MaintenanceRequest'],
    'maintenanceRequestCreated',
    ParentType,
    ContextType
  >
  maintenanceRequestDeleted?: SubscriptionResolver<
    ResolversTypes['Boolean'],
    'maintenanceRequestDeleted',
    ParentType,
    ContextType
  >
  maintenanceRequestResolved?: SubscriptionResolver<
    ResolversTypes['MaintenanceRequest'],
    'maintenanceRequestResolved',
    ParentType,
    ContextType
  >
  maintenanceRequestUpdated?: SubscriptionResolver<
    ResolversTypes['MaintenanceRequest'],
