...
export type FindAllMaintenanceRequestsQueryVariables = Exact<{
  [key: string]: never
}>

export type FindAllMaintenanceRequestsQuery = {
  __typename?: 'Query'
  findAllMaintenanceRequests?: Array<{
    __typename?: 'MaintenanceRequest'
    _id?: any | null
    title?: string | null
...
export type MaintenanceRequestDeletedSubscription = {
  __typename?: 'Subscription'
  maintenanceRequestDeleted?: boolean | null
}

export const FindAllMaintenanceRequestsDocument = {
  kind: 'Document',
  definitions: [
    {
